...
## D012 — Hero affiche industrielle
Date : 2026-09-08. Acceptée par le choix explicite de l’utilisateur « direction 2 », après présentation de trois propositions et annonce d’une implémentation après validation. Les portes 1–3 restent validées pour la préversion ; ce choix valide la porte 4 pour cette refonte ciblée.

Titre Archivo noir plein sur deux lignes desktop, trois sur mobile ; ponctuation Signal, fond Bone, plan Mineral incliné à 12°, cadre incomplet et mini-pelle au premier plan. Texte et actions regroupés ; « Demander une location » devient le bouton principal de la Hero. Le mouvement se limite au déploiement du plan et à une courte mise en place de la machine ; aucun texte masqué ou déplacé et respect de reduced-motion. Les autres sections et les parcours restent ceux de l’aperçu analysé.

La variante de mini-pelle est une illustration générée sur fond blanc, composée en mode multiply sur Bone/Mineral (pas de transparence alpha dans l’export). Elle reste réservée à la préversion ; une photo vérifiée demeure prioritaire. Aucun prix, capacité, contact ou disponibilité n’est ajouté.

Travail isolé dans codex/hero-affiche-20260908, worktree ../MK LOCATION-worktrees/hero-affiche-20260908. Base distante 16de642, visuels existants 36beeb1 et copie des quatre ajustements locaux visibles au moment de l’analyse sauvegardée dans 5c72b30. Le worktree source n’est pas modifié. Aucun push ni intégration main demandé.
